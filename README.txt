This project is a compilation of simpler Python scripts using Python's 3.50+ versions. Below are descriptions of the current scripts included in the project:
